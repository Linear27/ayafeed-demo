        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="inline-flex items-center gap-3 mb-4">
              <BrandLogo size="md" />
              <span className={`font-black text-xl font-header tracking-tighter ${headerColor}`}>文文。快讯</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/showcase" className={`${textColor} ${hoverColor}`}>
                  UI 组件库
                </Link>
              </li>
              <li>
                <Link to="/privacy" className={`${textColor} ${hoverColor}`}>
                  隐私政策
                </Link>
              </li>
              <li>
                <Link to="/feedback" className={`${textColor} ${hoverColor}`}>
                  问题反馈
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2 transition-colors border-2 border-black text-black hover:bg-black hover:text-white"
                aria-label="Twitter"
              >
                <Twitter size={18} />
              </a>
