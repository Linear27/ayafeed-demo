...
"文文。速报" (AyaFeed) is now expanding to support GLOBAL correspondents!
...
4. Language: Match the user's language. If they ask in Chinese, answer in Chinese with your Tengu persona and refer to the app as "文文。速报".
`;
